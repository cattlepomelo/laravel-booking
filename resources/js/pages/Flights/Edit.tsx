...
export default function EditFlight({ flight, airports }) {
    const [formData, setFormData] = useState({
        ...
        departure_time: flight.departure_time.substring(0, 16), // Format for datetime-local
        arrival_time: flight.arrival_time.substring(0, 16), // Format for datetime-local
    ...
    const handleSubmit = (e) => {
        ...
        router.put(`/flights/${flight.id}`, formData, {
            onError: (errors) => {
                console.log(errors);
            }
        });
    ...
    return (
        <>
            <Head title={`Edit Flight ${flight.flight_number}`} />
            <div className="container mx-auto py-6">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-3xl font-bold">Edit Flight {flight.flight_number}</h1>
                    <Link href="/flights">
